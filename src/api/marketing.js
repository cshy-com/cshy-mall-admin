 ...
 export function exportcombiantionApi(params) {
     return request({
         url: `/export/combiantion/product`,
         method: 'get',
         params
     })
 }
 ...
 // 礼品卡券---分页列表
 export function giftCardPage(data) {
     return request({
         url: `/admin/giftCard/page`,
         method: 'post',
         data
     })
 }
 // 礼品卡券---查一个
 export function giftCardObj(id) {
     return request({
         url: `/admin/giftCard/obj/${id}`,
         method: 'get'
     })
 }
 // 礼品卡券---删除
 export function giftCardDelete(data) {
     return request({
         url: `/admin/giftCard/delete?id=${data}`,
         method: 'delete',
 ...
 // 礼品卡券---停用启用
 export function giftCardUpdateStatus(params) {

     return request({
         url: `/admin/giftCard/updateStatus`,
         method: 'get',
         params
     })
 }
 // 礼品卡券---批量添加
 export function giftCardBatchAdd(data) {

     return request({
         url: `/admin/giftCard/batchAdd`,
         method: 'post',
         data
     })
 }
 //  礼品卡券修改
 export function giftCardUpdate(data) {

     return request({
         url: `/admin/giftCard/update/batch`,
         method: 'post',
         data
     })
 }
 ...
 //  礼品卡类型---分页
 export function giftCardTypePage(data) {
     return request({
         url: `/admin/giftCard/type/page`,
         method: 'post',
         data
     })
 }
 // 礼品卡卡类型列表
 export function giftCardTypeList(data) {
     return request({
         url: `/admin/giftCard/type/list`,
         method: 'post',
         data
     })
 }
 // 礼品卡类型删除
 export function giftCardTypeDelete(data) {
     return request({
         url: `/admin/giftCard/type/delete?id=${data}`,
         method: 'delete',

     })
 }
 // 礼品卡类型停用启用
 export function giftCardTypeUpdateStatus(params) {

     return request({
         url: `/admin/giftCard/type/updateStatus`,
         method: 'get',
         params
     })
 }
 ...
 // 礼品卡类型新增
 export function giftCardTypeAdd(data) {

     return request({
         url: `/admin/giftCard/type/add`,
         method: 'post',
         data
     })
 }
 ...
 // 礼品卡类型编辑
 export function giftCardTypeUpdate(data) {

     return request({
         url: `/admin/giftCard/type/update`,
         method: 'post',
         data
     })
 }
 // 礼品卡券查看密码
 export function giftCardViewSecret(params) {

     return request({
         url: `/admin/giftCard/viewSecret`,
         method: 'get',
         params
     })
 }
 // 礼品卡类型关联商品
 export function giftCardProductBatchAdd(id, data) {

     return request({
         url: `/admin/giftCard/product/batchAdd?giftCardTypeId=${id}`,
         method: 'post',
         data
     })
 }
 // 礼品卡类型取消关联商品
 export function giftCardProductDelete(data) {
     return request({
         url: `/admin/giftCard/product/delete?id=${data}`,
         method: 'delete'

     })
 }
 // 礼品卡类型查看已经关联的商品
 export function giftCardProductPage(data) {

     return request({
         url: `/admin/giftCard/product/page`,
         method: 'post',
         data
     })
 }
 // 查询礼品卡订单
 export function giftCardOrderPage(data) {

     return request({
         url: `/admin/giftCard/order/page`,
         method: 'post',
         data
     })
 }
 export function giftCardOrderUpdate(data) {

     return request({
         url: `/admin/giftCard/order/update`,
         method: 'post',
         data
     })
 }
 export function findExpressDetail(params) {

     return request({
         url: `/admin/express/findExpressDetail`,
         method: 'get',
         params
     })
 }
 ...
 export function orderShip(params) {
     ...
     return request({
         url: `/admin/giftCard/order/ship`,
         method: 'get',
         params
     })
 }

 export function giftCardOrderStatusNum(params) {

     return request({
         url: `/admin/giftCard/order/status/num`,
         method: 'get',
         params
     })
 }
 //移动端首页banner位查询
 export function bannerActivityConfigPage(data) {

     return request({
         url: `/admin/sys/banner/activity/config/page`,
         method: 'post',
         data
     })
 }
 //  移动端首页banner位更新
 export function bannerActivityConfigUpdate(data) {

     return request({
         url: `/admin/sys/banner/activity/config/update`,
         method: 'post',
         data
     })
 }
 export function adminActivityCategoryPage(data) {

     return request({
         url: `/admin/activity/category/page`,
         method: 'post',
         data
     })
 }
 export function adminActivityCategoryList(data) {

     return request({
         url: `/admin/activity/category/list`,
         method: 'post',
         data
     })
 }
 export function adminActivityCategoryAdd(data) {

     return request({
         url: `/admin/activity/category/add`,
         method: 'post',
         data
     })
 }
 export function adminActivityCategoryUpdate(data) {

     return request({
         url: `/admin/activity/category/update`,
         method: 'post',
         data
     })
 }
 export function adminActivityCategoryDetete(data) {
     return request({
         url: `/admin/activity/category/delete?id=${data}`,
         method: 'delete'
