              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="18" :xl="18">
                <el-col v-bind="grid">
                  <el-form-item label="用户搜索：">
                    <el-input  @keyup.enter.native="userSearchs" v-model="userFrom.keywords" placeholder="请输入姓名或手机号" clearable  class="selWidth"/>
                  </el-form-item>
                </el-col>
              </el-col>
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item @click.native="editPoint(scope.row.uid)" v-if="checkPermi(['admin:user:operate:founds'])">积分</el-dropdown-item>
    ...
    <el-dialog
      ...
      <!--  <el-form-item
        ...
        <el-form-item
          ...
          required
        >
          <el-input-number type="text"  :precision="2"  :step="1" v-model="PointValidateForm.integralValue" :min="0" :max="999999"></el-input-number>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
