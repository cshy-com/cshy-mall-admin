 ...
 * @Date: 2023-10-27 16:49:14
 * @LastEditors: zhang00001 774004514@qq.com
 * @LastEditTime: 2024-06-05 20:41:20
 * @FilePath: \cshy-wechatd:\work\cshy-admin\src\views\store\creatStore\index.vue
    ...
    <el-card class="box-card">
      ...
      >
        <el-row v-show="currentTab === 0" :gutter="24">
          ...
          <el-col :span="24">
            <el-form-item prop="isDeliver" label="配送方式：">
              <el-checkbox v-model="formValidate.isDeliver">商家配送</el-checkbox>
              <el-checkbox v-model="formValidate.isPickup">到店自提</el-checkbox>
              </el-form-item>
          </el-col>
          <el-col :xs="18" :sm="18" :md="18" :lg="12" :xl="12" v-if='formValidate.isDeliver'>
            <el-form-item label="运费模板：" prop="tempId"     :rules="[
      { required: true, message: '运费模板不能为空'},
...
>
          ...
          <el-col :xs="6" :sm="6" :md="6" :lg="12" :xl="12" v-if='formValidate.isDeliver'>
...
<!--           
          <el-col :span="24">
            <el-form-item prop="isDeliver" label="是否商家配送：">
              <el-checkbox v-model="formValidate.isDeliver">是</el-checkbox>
            </el-form-item> 
            <el-form-item prop="isPickup" label="是否到店自提：">
              <el-checkbox v-model="formValidate.isPickup">是</el-checkbox>
            </el-form-item>
            </el-col> -->
          <el-col :span="24">
          ...
          >
            <el-form-item label="选择规格：" prop="">
              <div class="acea-row">
                ...
                <!-- <el-button type="primary" class="mr20" @click="confirm"
                  >确认</el-button
                > -->
...
const defaultObj = {
  ...
  isPickup:false,isDeliver:false,
...
export default {
  ...
  methods: {
      ...
      productDetailApi(this.$route.params.id)
        .then(async (res) => {
          ...
          this.formValidate = {
            ...
            sliderImages: info.sliderImage ? JSON.parse(info.sliderImage) : [],
            ...
            content: info.content
              ? this.$selfUtil.replaceImgSrcHttps(info.content)
              : null,
          ...
          let imgs = info.sliderImage ? JSON.parse(info.sliderImage) : [];
          let imgss = [];
          ...
          if (info.specType) {
            ...
            this.ManyAttrValue.forEach((val) => {
              ...
              this.attrInfo[Object.values(val.attrValue).sort().join("/")] =
                val;
            });
    ...
    if([this.formValidate.isDeliver,this.formValidate.isPickup].every(e=>["",null,undefined,false].includes(e))){
      return this.$message.error('请选择商家配送/到店自提')
    }
    ...
    handleSubmit: Debounce(function (name) {
      ...
      if (this.formValidate.specType) {
        ...
        let id = 0;
        if (this.$route.params.id) {
          if (this.formValidate.attr.length > 0) {
            id = this.formValidate.attr[0].id;
          }
        }
        this.formValidate.attr = [
          { attrName: "规格", attrValues: "默认", id: id, type: 0 },
        ];
        this.OneattrValue.map((item) => {
