    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-form-item style="margin-top:30px;">
          <el-button
            v-show="(!$route.params.id && currentTab > 0) || ($route.params.id && currentTab===1)"
            type="primary"
            class="submission"
            size="small"
    ...
    data() {
      return {
        ...
        ruleValidate: {
          ...
          info: [
            { required: true, message: '请输入活动商品简介', trigger: 'blur' }
          ],
          tempId: [
              ...
              this.$route.params.id
                ? seckillStoreUpdateApi({id: this.$route.params.id}, this.formValidate)
                  .then(async () => {
                    ...
                    this.$router.push({
                      path: "/marketing/active/activeList?type="+this.routerType
                    });
