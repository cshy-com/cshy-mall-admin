  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form inline>
            ...
            <el-form-item label="配置名称：">
              ...
              <!--<el-input v-model="tableFrom.name" placeholder="请输入活动名称" class="selWidth">-->
        ...
        <router-link
          :to="{
            path: '/marketing/active/creatActive/creat?type=' + routerType,
          }"
        >
          <el-button
            size="small"
      ...
      >
        ...
        <el-table-column prop="name" label="活动时段" min-width="130">
          <template slot-scope="scope">
            <div>
              {{
                scope.row.storeSeckillManagerResponse
        ...
        <el-table-column label="活动价" min-width="100" prop="price" />
        <el-table-column label="限量" prop="quotaShow" min-width="80" />
        <el-table-column label="限量剩余" min-width="80" prop="quota" />
        <el-table-column label="活动状态" min-width="100" prop="statusName" />
        ...
        >
          <template slot-scope="scope">
            <router-link
              :to="{
                path:
                  '/marketing/active/creatActive/updeta/' +
                  scope.row.productId +
                  '/' +
                  scope.row.id,
              }"
...
export default {
  ...
  mounted() {
    getSeckillList().then((res) => {
      this.seckillTime = res.list.filter((val) => val.type == this.routerType);
    });
  },
  watch: {
    $route: {
