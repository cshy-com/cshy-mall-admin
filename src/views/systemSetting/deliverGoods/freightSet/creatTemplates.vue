  ...
  >
    <el-form ref="ruleForm" :model="ruleForm" label-width="120px" size="mini" v-if="dialogVisible" :rules="rules">
      ...
      <el-form-item label="满减"  >
        满  <el-input-number :min="0" :controls="false" v-model="ruleForm.fullReductionAmount" :precision="2" :step="1" style="width: 150px;" class="withs" placeholder="" />
        
        <div style="font-size:12px">请输入大于0的两位小数</div> 
     
      </el-form-item>
      <el-form-item label="是否包邮"    >
        <el-radio-group v-model="ruleForm.isFreePostage"    size="mini">
      ...
      <el-form-item label=""  >
      减 <el-input  style="width: 150px;" :disabled="ruleForm.isFreePostage" v-model="ruleForm.deductionPostage" class="withs" placeholder="" />
    </el-form-item>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary"  :loading="loading" @click="onsubmit('ruleForm')" v-hasPermi="['admin:shipping:templates:update']">确 定</el-button>
    </span>
  </el-dialog>
</template>
    ...
    getInfo(id, appoint) {
      ...
      logistics.templateDetailApi({ id }).then(res => {
        ...
        this.ruleForm = Object.assign(this.ruleForm, {
          ...
          sort: info.sort,
          isFreePostage:info.isFreePostage,
  fullReductionAmount:info.fullReductionAmount,
  deductionPostage:info.deductionPostage
        })
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          const param = {
            ...
            isFreePostage:this.ruleForm.isFreePostage,
  fullReductionAmount:this.ruleForm.fullReductionAmount,
  deductionPostage:this.ruleForm.isFreePostage?0:this.ruleForm.deductionPostage
            // 配送区域及运费
