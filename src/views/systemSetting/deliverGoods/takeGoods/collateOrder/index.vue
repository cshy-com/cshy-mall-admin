          ...
          <el-form size="small" label-width="100px" :inline="true">
            ...
            <el-form-item label="关键字：">
              <el-input
                ...
                class="selWidth"
                size="small"
                clearable @keyup.enter.native="getList(1)"
              >
                <el-button
                  slot="append"
                  icon="el-icon-search"
              ...
              <el-button   type="primary" size="small" @click="printJS('printJS-form', 'html')">
                打印配送单
              </el-button>
            </el-form-item>
          </el-form>
...
import detailsFrom from './../../../../order/orderDetail'
import { checkPermi } from "@/utils/permission"; 
import printModel from "./../../../../order/printModel"
export default {
  components: { cardsData ,detailsFrom,printModel},
  data() {
    return {
      storeSelectList: [],
      orderId: 0,
  ...
  beforeDestroy(){if (this.intervalId) {
