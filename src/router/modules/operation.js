 ...
 const operationRouter = {
     ...
     children: [{
             ...
             name: 'setting',
             component: () =>
                 import ('@/views/systemSetting/setting'),
             meta: {
                 title: '系统设置',
                 icon: 'clipboard'
             }
         },
         {
             ...
             name: 'notification',
             component: () =>
                 import ('@/views/systemSetting/notification'),
             meta: {
                 title: '消息通知',
                 icon: 'clipboard'
             }
         },
         {
             ...
             name: 'messageLog',
             component: () =>
                 import ('@/views/systemSetting/messageLog'),
             meta: {
                 title: '短信日志',
                 icon: 'clipboard'
             }
         },
         {
             ...
             component: () =>
                 import ('@/views/systemSetting/messageTemplate'),
             meta: {
                 title: '短信模板管理',
                 icon: 'clipboard'
             }
             ...
             name: 'messageSign',
             component: () =>
                 import ('@/views/systemSetting/messageSign'),
             meta: {
                 title: '短信签名管理',
                 icon: 'clipboard'
             }
         ...
         },
         {
             ...
             name: 'RoleManager',
             component: () =>
                 import ('@/views/systemSetting/administratorAuthority'),
             meta: {
                 title: '管理权限',
                 icon: 'clipboard',
                 roles: ['admin']
         ...
         },
         {
             ...
             alwaysShow: true,
             component: () =>
                 import ('@/views/systemSetting/deliverGoods'),
             meta: {
                 title: '发货设置',
                 roles: ['admin']
             },
