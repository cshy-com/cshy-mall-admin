 ...
 const appSettingRouter = {
     ...
     children: [{
         ...
         name: 'publicAccount',
         component: () =>
             import ('@/views/appSetting/wxAccount'),
         meta: {
             title: '公众号',
             icon: 'clipboard',
             roles: ['admin']
         ...
         children: [{
                 path: 'wxMenus',
                 component: () =>
                     import ('@/views/appSetting/wxAccount/wxMenus'),
                 name: 'wxMenus',
             ...
             },
             {
                 path: 'wxReply',
                 component: () =>
                     import ('@/views/appSetting/wxAccount/reply/index'),
                 name: 'wxReply',
                 meta: { title: '自动回复', icon: '' },
                 children: [{
                         path: 'follow',
                         component: () =>
                             import ('@/views/appSetting/wxAccount/reply/follow'),
                         name: 'wxFollow',
                     ...
                     },
                     {
                         path: 'keyword',
                         component: () =>
                             import ('@/views/appSetting/wxAccount/reply/keyword'),
                         name: 'wxKeyword',
