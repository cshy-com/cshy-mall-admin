 ...
 const storeRouter = {
     ...
     children: [{
             ...
             name: 'StoreIndex',
             meta: { title: '商品管理', icon: '', keepAlive: true, }
         },
         {
             path: 'sort',
             component: () =>
                 import ('@/views/store/sort/index'),
             name: 'Sort',
         ...
         },
         {
             path: 'attr',
             component: () =>
                 import ('@/views/store/storeAttr/index'),
             name: 'SortAttr',
         ...
         },
         {
             path: 'comment',
             component: () =>
                 import ('@/views/store/storeComment/index'),
             name: 'StoreComment',
         ...
         },
         {
             ...
             component: () =>
                 import ('@/views/store/creatStore/index'),
             name: 'SortCreat',
